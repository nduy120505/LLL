--PHONGBAN (MAPB, TENPB, DIACHI, SODT, CHUCNANG, SONV)

--CHUCVU (MACV, TENCV, HESOCV, GHICHU)

--NHANVIEN(MANV, HOTEN, NGAYSINH, GIOITINH,NOISINH, HSL, MAPB,MACV)

QUATRINH(MAQT, MANV, TUNGAY, DENNGAY, VITRI, GHICHU)

LUONG(MALUONG, THANGNAM, MANV, LUONGCB, THUONG, KHAUTRU, TONGLINH)

Câu 1: 

Thiết lập cơ sở dữ liệu để quản lý thông tin với kiểu dữ liệu và ràng buộc phù hợp thực tế. Đặt tên file và tên CSDL: SQL_<HotenSV>

Câu 2:

Sử dụng lệnh INSERT nhập dữ liệu cho các bảng phù hợp với bài toán; Chạy câu lệnh SELECT * FROM  <TenBang> và EXEC SP_HELP <TenBang> và chụp toàn bộ dữ liệu đã nhập và cấu trúc bảng ra file MSWord. Đặt tên: SQL_<HotenSV>

Câu 3:

a.    Tạo VIEW cho biết toàn bộ thông tin về Nhân Viên, toàn bộ thông tin Lương, Tính tổng tiền lĩnh. Không dùng alias cho các bảng. Chạy lệnh hiển thị kết quả trong View và chụp ảnh ra Word

b.    Tạo VIEW cho biết tổng số nhân viên theo từng phòng ban.

Chạy lệnh hiển thị kết quả trong View và chụp ảnh ra file MSWord

Câu 4:

a.    Viết thủ tục sửa thông tin THƯỞNG, KHẤU TRỪ của bất kỳ nhân viên nào trong bảng lương (các thông tin khác không đổi)

b.    Viết thủ tục xóa dữ liệu trong bảng chức vụ.

Chạy kết quả và chụp toàn bộ ra file MSWord

Câu 5:  

a.    Viết Trigger tính toán Tổng lĩnh Lương khi thêm hoặc cập nhật thông tin về lương cũng như nhân viên.

b.    Viết thủ tục thống kê với tham số đầu vào: lựa chọn, tháng năm

·       Lựa chọn 1: Cho biết tổng lương của từng phòng ban theo tháng năm

·       Lựa chọn 2: Cho biết tổng lương của từng chức vụ theo tháng năm

Chạy kết quả và chụp toàn bộ ra file MSWord

TongLinh = LuongCB* (HSL + HESOCV) + Thuong - KhauTru
